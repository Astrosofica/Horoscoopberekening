    ...
    <div class="card card--large card--progression-events">
        ...
        <form method="POST" class="progression-form">
            ...
            <div class="progression-column progression-column--aspects">
                ...
                foreach ($aspectOptions as $aspDeg): ?>
                    <label>
                        ...
                        <span class="astro-glyph"><?= \Tijd\Glyph\SymbolGlyph::getAspectGlyph($aspDeg) ?></span>
                    </label>
                <?php endforeach; ?>
            </div>
            ...
            <div class="progression-column progression-column--radix">
                ...
                <?php 
                $radixPlanetLabels = [
                    0 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(0), 'name' => 'Zon'],
                    1 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(1), 'name' => 'Maan'],
                    2 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(2), 'name' => 'Mercurius'],
                    3 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(3), 'name' => 'Venus'],
                    4 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(4), 'name' => 'Mars'],
                    5 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(5), 'name' => 'Jupiter'],
                    6 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(6), 'name' => 'Saturnus'],
                    7 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(7), 'name' => 'Uranus'],
                    8 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(8), 'name' => 'Neptunus'],
                    9 => ['glyph' => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(9), 'name' => 'Pluto'],
                ];
                ...
                <?php 
                $radixAxisLabels = [
                    10 => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(10),
                    11 => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(11),
                    12 => \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex(12),
                ];
            ...
            <tbody>
                <?php foreach ($progEventsResult as $event): ?>
                    <tr class="<?= $event['event_type'] === 'rd_transition' ? 'row--rd' : '' ?><?= ($event['event_type'] === 'house_ingress' || $event['event_type'] === 'sign_ingress') ? 'row--ingress' : '' ?>">
                        ...
                        <td><span class="astro-glyph"><?= \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex($event['progressive_index']) ?></span></td>
                        <td><span class="astro-glyph"><?= \Tijd\Glyph\SymbolGlyph::getAspectGlyph($event['aspect']) ?></span></td>
                        <td>
                            <?php if ($event['radix_index'] >= 40 && $event['radix_index'] <= 51): ?>
                                <?= \Tijd\Glyph\SymbolGlyph::getGlyphForTarget($event['radix_index']) ?>
                        ...
                        <td><?= \Tijd\Helpers\Formatter::formatLongitudeWithGlyph($event['progressive_position']) ?></td>
                        <td><?= \Tijd\Helpers\Formatter::formatLongitudeWithGlyph($event['radix_position']) ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
