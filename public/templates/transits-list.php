                ...
                <div class="transit-column transit-column--planets">
                    ...
                    foreach ($transitPlanetNames as $idx => $tName): ?>
                        <label>
                            ...
                            <span class="astro-glyph"><?= \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex($idx) ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
            ...
            <tbody>
                ...
                <tr class="<?= $event['event_type'] === 'house_ingress' ? 'row--ingress' : '' ?>">
                    ...
                    <td class="text-center">
                        <span class="astro-glyph"><?= \Tijd\Glyph\SymbolGlyph::getPlanetGlyphByIndex($event['tplanet']) ?></span>
                    </td>
                    <td class="text-center">
                        <span class="astro-glyph"><?= \Tijd\Glyph\SymbolGlyph::getAspectGlyph($event['aspect']) ?></span>
                    </td>
                    <td class="text-center">
                        <?php if ($event['rplanet'] >= 40 && $event['rplanet'] <= 51): ?>
                            <?= \Tijd\Glyph\SymbolGlyph::getGlyphForTarget($event['rplanet']) ?>
                        <?php else: ?>
                            <span class="astro-glyph"><?= \Tijd\Glyph\SymbolGlyph::getGlyphForTarget($event['rplanet']) ?></span>
                        <?php endif; ?>
                    </td>
                    <td class="text-center"><?= \Tijd\Helpers\Formatter::formatLongitudeWithGlyph($event['tlong']) ?></td>
                    <td class="text-center"><?= \Tijd\Helpers\Formatter::formatLongitudeWithGlyph($event['rlong']) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
