...
$colors = [
    ...
    'magenta'       => imagecolorallocate($im, 120, 100, 115),

    // Ringen en grote vlakken
    'yellow'        => imagecolorallocate($im, 226, 226, 214),
    'cyan'          => imagecolorallocate($im, 205, 215, 210),

    // Groentinten
    'green'         => imagecolorallocate($im, 123, 150, 105),
    'light_green'   => imagecolorallocate($im, 186, 200, 177),

    // Neutrale tinten en tekst
    'grey'          => imagecolorallocate($im, 140, 145, 135),
    'black'         => imagecolorallocate($im, 45, 49, 44),

    // De Elementen (Glyphes op de ring)
    'red'           => imagecolorallocate($im, 166, 91, 82),
    'another_green' => imagecolorallocate($im, 64, 78, 59),
    'orange'        => imagecolorallocate($im, 184, 134, 77),
    'blue'          => imagecolorallocate($im, 108, 132, 128),

    // Extra accenten
    'lavender'      => imagecolorallocate($im, 165, 165, 175),
    'light_blue'    => imagecolorallocate($im, 235, 240, 238),
];
