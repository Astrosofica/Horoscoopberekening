...
$colors = [
    'white' => imagecolorallocate($im, 255, 255, 255),
    'whitesmoke' => imagecolorallocate($im, 238, 242, 239),
    'red' => imagecolorallocate($im, 154, 70, 70),
    'blue' => imagecolorallocate($im, 46, 96, 110),
    'magenta' => imagecolorallocate($im, 86, 78, 128),
    'yellow' => imagecolorallocate($im, 231, 238, 220),
    'cyan' => imagecolorallocate($im, 198, 222, 222),
    'green' => imagecolorallocate($im, 122, 162, 132),
    'light_green' => imagecolorallocate($im, 191, 216, 184),
    'another_green' => imagecolorallocate($im, 74, 112, 86),
    'grey' => imagecolorallocate($im, 132, 140, 140),
    'black' => imagecolorallocate($im, 43, 43, 43),
    'lavender' => imagecolorallocate($im, 108, 98, 150),
    'orange' => imagecolorallocate($im, 170, 118, 84),
    'light_blue' => imagecolorallocate($im, 228, 238, 242),
];
*/
/*
// Donkerder en rijker
$colors = [
    'white' => imagecolorallocate($im, 255, 255, 255),
    'whitesmoke' => imagecolorallocate($im, 236, 236, 230),
    'red' => imagecolorallocate($im, 170, 62, 52),
    'blue' => imagecolorallocate($im, 52, 74, 126),
    'magenta' => imagecolorallocate($im, 92, 60, 126),
    'yellow' => imagecolorallocate($im, 220, 228, 204),
    'cyan' => imagecolorallocate($im, 186, 216, 220),
    'green' => imagecolorallocate($im, 104, 146, 92),
    'light_green' => imagecolorallocate($im, 172, 204, 156),
    'another_green' => imagecolorallocate($im, 60, 98, 54),
    'grey' => imagecolorallocate($im, 126, 126, 126),
    'black' => imagecolorallocate($im, 30, 30, 32),
    'lavender' => imagecolorallocate($im, 118, 90, 156),
    'orange' => imagecolorallocate($im, 176, 102, 58),
    'light_blue' => imagecolorallocate($im, 220, 230, 240),
];
*/
/*
// Klassiek
$colors = [
    'white' => imagecolorallocate($im, 255, 255, 255),
    'whitesmoke' => imagecolorallocate($im, 244, 240, 232),
    'red' => imagecolorallocate($im, 156, 58, 58),
    'blue' => imagecolorallocate($im, 88, 108, 136),
    'magenta' => imagecolorallocate($im, 122, 46, 58),
    'yellow' => imagecolorallocate($im, 236, 232, 216),
    'cyan' => imagecolorallocate($im, 196, 214, 214),
    'green' => imagecolorallocate($im, 140, 156, 108),
    'light_green' => imagecolorallocate($im, 200, 212, 180),
    'another_green' => imagecolorallocate($im, 92, 108, 72),
    'grey' => imagecolorallocate($im, 142, 134, 126),
    'black' => imagecolorallocate($im, 47, 41, 38),
    'lavender' => imagecolorallocate($im, 126, 102, 150),
    'orange' => imagecolorallocate($im, 156, 106, 67),
    'light_blue' => imagecolorallocate($im, 228, 232, 230),
];
*/
// zacht blauwgrijs
/*
$colors = [
    'white' => imagecolorallocate($im, 255, 255, 255),
    'whitesmoke' => imagecolorallocate($im, 238, 242, 246),
    'red' => imagecolorallocate($im, 160, 72, 72),
    'blue' => imagecolorallocate($im, 70, 108, 150),
    'magenta' => imagecolorallocate($im, 92, 86, 146),
    'yellow' => imagecolorallocate($im, 226, 234, 242),
    'cyan' => imagecolorallocate($im, 196, 224, 232),
    'green' => imagecolorallocate($im, 128, 156, 176),
    'light_green' => imagecolorallocate($im, 188, 210, 224),
    'another_green' => imagecolorallocate($im, 88, 116, 138),
    'grey' => imagecolorallocate($im, 132, 140, 150),
    'black' => imagecolorallocate($im, 36, 40, 46),
    'lavender' => imagecolorallocate($im, 108, 104, 164),
    'orange' => imagecolorallocate($im, 176, 118, 88),
    'light_blue' => imagecolorallocate($im, 232, 242, 250),
];
*/
/*
//Dieper petrol
$colors = [
    'white' => imagecolorallocate($im, 255, 255, 255),
    'whitesmoke' => imagecolorallocate($im, 236, 241, 244),
    'red' => imagecolorallocate($im, 155, 68, 68),
    'blue' => imagecolorallocate($im, 36, 92, 122),
    'magenta' => imagecolorallocate($im, 74, 76, 140),
    'yellow' => imagecolorallocate($im, 220, 230, 238),
    'cyan' => imagecolorallocate($im, 178, 214, 224),
    'green' => imagecolorallocate($im, 94, 140, 158),
    'light_green' => imagecolorallocate($im, 166, 198, 214),
    'another_green' => imagecolorallocate($im, 58, 98, 114),
    'grey' => imagecolorallocate($im, 126, 136, 144),
    'black' => imagecolorallocate($im, 30, 34, 40),
    'lavender' => imagecolorallocate($im, 100, 92, 160),
    'orange' => imagecolorallocate($im, 170, 112, 76),
    'light_blue' => imagecolorallocate($im, 224, 236, 246),
];
*/
/*
// nacht blauw
$colors = [
    'white' => imagecolorallocate($im, 255, 255, 255),
    'whitesmoke' => imagecolorallocate($im, 234, 238, 244),
    'red' => imagecolorallocate($im, 166, 62, 62),
    'blue' => imagecolorallocate($im, 42, 72, 136),
    'magenta' => imagecolorallocate($im, 84, 70, 148),
    'yellow' => imagecolorallocate($im, 214, 224, 236),
    'cyan' => imagecolorallocate($im, 170, 202, 224),
    'green' => imagecolorallocate($im, 90, 124, 162),
    'light_green' => imagecolorallocate($im, 160, 188, 220),
    'another_green' => imagecolorallocate($im, 56, 84, 120),
    'grey' => imagecolorallocate($im, 122, 130, 142),
    'black' => imagecolorallocate($im, 24, 28, 36),
    'lavender' => imagecolorallocate($im, 104, 88, 170),
    'orange' => imagecolorallocate($im, 176, 108, 70),
    'light_blue' => imagecolorallocate($im, 220, 232, 246),
];
*/
// lavendel/salie idee
...
function draw_planets($im, $center_pt, $planets, $house_cusps, $radius, $inner_diameter_offset, $spacing, $colors) {
    ...
    for ($i = $num_planets - 1; $i >= 0; $i--) {
        ...
        if ($speeds[$sort_pos[$i]] < 0) {
            ...
            imagettftext($im, 10, 0, (int)($xy[0] + $center_pt), (int)($xy[1] + $center_pt), $colors['red'], HAMBURG_FONT, chr(118)); // 118 was 62
        }
    }
}
